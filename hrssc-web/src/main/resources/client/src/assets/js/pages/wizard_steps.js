...
/* ---------------------------------fix bug------------------------------------------- */
let wizardStepsJsTu = setTimeout(function runAgain() {
    if (window.wizardStepsTu) {
        window.wizardStepsTu = false;
        // console.log('-----------------run aaaaaaaaa-----------');
        /* ---------------------------------end bug------------------------------------------- */
        ...
        $(function () {
            ...
            $(".steps-basic").steps({
                ...
                onFinished: function (event, currentIndex) {
                    ...
                    // call addNewResource function
                    window.resourceManagerPopoverComponent.addNewResource();
                }
            });
    ...
    wizardStepsJsTu = setTimeout(runAgain, 1000);
}, 1000);